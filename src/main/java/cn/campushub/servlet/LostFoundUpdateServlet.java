...
/**
 * 接收失物招领的更新请求，调用业务层并生成 HTTP 响应。
 */
public class LostFoundUpdateServlet extends HttpServlet {
    private final LostFoundService service = new LostFoundService();

    /**
     * 处理`LostFoundUpdate`相关的 HTTP POST 请求并生成响应。
     *
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ServiceResult<Void> result = service.update(
                    id,
                    user.id(),
